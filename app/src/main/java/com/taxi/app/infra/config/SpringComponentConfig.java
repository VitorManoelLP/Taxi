...
public class SpringComponentConfig {
    ...
    @Bean
    public RidePrice ridePrice(CalculateDistance calculateDistance, HoursResolver hoursResolver, RequestRide requestRide) {
        return new RidePrice(calculateDistance, hoursResolver, requestRide);
    }
